...
const Laurels = () => {
  ...
  <section id='Laurels' className='section-background'>
    <div className='laurels-wrapper p-8 sm:p-16'>
      <div className='laurels-content flex flex-col items-center lg:items-start lg:flex-row md:justify-evenly '>
          <div className='left-div text-center'>
              <div className='laurels-header text-start'>
                <SubHeading title="Awards & Recognition" className="p-Cormorant text-[19px] lg:text-[24px]" />
